...
public class RSAUtils {
    ...
    public static String decodeByPublic(String str, String publicKeyStr) throws Exception{
    	...
    	//解密报文
    	String decodedData = RSAUtils.publicDecrypt(str, publicKey);
    	return decodedData;
    }
    /**
     * 私钥解密
    ...
    public static String decodeByprivate(String str, String privateKeyStr) throws Exception{
    	...
    	//解密报文
    	String decodedData = RSAUtils.privateDecrypt(str, privateKey);
    	return decodedData;
    }
    ...
    public static String encodeByPrivate(String str, String privateKeyStr) throws Exception{
    	//获取私钥
    	RSAPrivateKey privateKey = RSAUtils.getPrivateKey(privateKeyStr);
    	String encodedData = RSAUtils.privateEncrypt(str, privateKey);
    	return encodedData;
    }
    /**
     * 公钥加密
    ...
    public static Map<String, String> getKeys(String num){
        Map<String, String> keyMap = RSAUtils.createKeys(Integer.parseInt(num));
